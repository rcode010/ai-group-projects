...
| Timestamp | Event | RAM% | Details | Top Processes |
|---|---|---|---|---|
| 2024-01-01 10:00:10 | RAM_HIGH | 55% | Threshold breached | pycharm64.exe(6.22%), MemCompression(2.17%) |
| 2024-01-01 10:01:00 | EMAIL_SENT | 58% | Alert email sent | pycharm64.exe(6.22%), MemCompression(2.17%) |
| 2024-01-01 10:03:00 | RESTART | 65% | System restart triggered | pycharm64.exe(7.1%), chrome.exe(3.4%) |
| 2024-01-01 10:03:10 | RAM_NORMAL | 42% | RAM back to normal | pycharm64.exe(5.9%), MemCompression(2.1%) |
| 2024-01-01 12:00:00 | SNAPSHOT | 48% | Scheduled 6-hour report | pycharm64.exe(6.0%), MemCompression(2.0%) |
...
| Name | Responsibility |
|---|---|
| Raman | System architecture, message bus, main orchestrator |
| Raman | MonitorAgent |
| Raman | AlertAgent |
| Rand | EmailAgent |
| Zmnako | LoggerAgent |
| Bahoz | RecoveryAgent |
| Hunar | DashboardAgent |