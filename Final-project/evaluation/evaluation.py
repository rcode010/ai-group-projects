# =============================================================================
# evaluation.py
# Purpose: Load all 4 trained models, evaluate them on the test set,
#          print a side-by-side comparison table, and explain the results.
#
# Metrics explained:
...
#               Of all animals predicted Dangerous, how many truly were?
#               → High precision = fewer false alarms.
#
#   Recall    = True Positives / (True Positives + False Negatives)
#               Of all truly Dangerous animals, how many did we catch?
#               → High recall = fewer missed dangerous cases.
#               → In medical/safety contexts, HIGH RECALL IS CRITICAL.
#
